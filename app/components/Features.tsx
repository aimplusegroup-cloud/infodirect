...
export default function Features({ setStage }) {
  const items = [
    { icon: "💼", title: "فرصت‌های شغلی پنهان", desc: "جویای کار؟ این داده‌ها پلی به کسب و کارهایی است که به تخصص شما نیاز دارند" },
  ...
  return (
    <div className="text-center max-w-5xl mx-auto px-4">
      ...
      >
        چرا این فایل می‌تواند مسیر شما را تغییر دهد؟
      </motion.h2>
